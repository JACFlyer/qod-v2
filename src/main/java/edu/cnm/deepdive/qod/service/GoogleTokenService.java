...
public class GoogleTokenService implements ResourceServerTokenServices {
  ...
  public OAuth2Authentication loadAuthentication(String token)
    ...
    if (idToken != null) {
      ...
      // TODO Get any additional info from payload for current user.
      ...
      Authentication base = new UsernamePasswordAuthenticationToken
          (oauthKey, token, grants);
      //  TODO Use user object retrieved from user service instead of oauthKey.
      OAuth2Request request = converter.extractAuthentication(payload)
          .getOAuth2Request();
